...
public class AttendanceController {
	...
	public String indexCheck(Model model, @Param("lmsUserId") Integer lmsUserId,Integer courseId,
		...
		List<AttendanceManagementDto> attendanceManagementDtoList = studentAttendanceService
				.getAttendanceManagement(loginUserDto.getCourseId(), loginUserDto.getLmsUserId(), model,
						tStudentAttendance.getTrainingStartTime(), tStudentAttendance.getTrainingEndTime());
